...
def _insert_response_votes(users):
    DB_SESSION.execute(
        insert(Vote),
        [
            {
...
users = [
    {"username": "testuser1", "id": uuid.uuid4()},
    {"username": "testuser2", "id": uuid.uuid4()},
    {"username": "testuser3", "id": uuid.uuid4()},
    {"username": "testuser4", "id": uuid.uuid4()},
    {"username": "testuser5", "id": uuid.uuid4()},
]

_insert_users(users)
_insert_debates(users)
_insert_debate_categories()
_insert_debate_debate_category_relationships()
_insert_responses(users)
_insert_response_votes(users)
